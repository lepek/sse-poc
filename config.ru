require './application'
Servalot::Application.initialize!

# Development middlewares
if Servalot::Application.env == 'development'
  ...
  use Rack::Static, :urls => ["/javascripts"], :root => Servalot::Application.root(:public)
end
...
#
run Servalot::Application.routes
